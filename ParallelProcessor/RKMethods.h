...
public:
	RKMethodA()
	{
		...
		c = { 0.0, 1.0 / 18, 1.0 / 6, 2.0 / 9, 2.0 / 3, 1.0, 8.0 / 9, 1.0 };
		b_main = { 3.0 / 80, 0.0, 4.0 / 25, 243.0 / 1120, 77.0 / 160, 73.0 / 700, 0.0, 0.0 };
		b_subs = { 57.0 / 640, 0.0, -16.0 / 65, 1377.0 / 2240, 121.0 / 320, 0.0, 891.0 / 8320, 2.0 / 35 };
	}
};
